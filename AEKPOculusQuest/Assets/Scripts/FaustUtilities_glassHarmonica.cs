...
*/
namespace FaustUtilities_glassHarmonica {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_glassHarmonica))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_glassHarmonica _dsp;
		...
		private void OnEnable() {
			fJSON = "{	\"name\": \"glassHarmonica\",	\"filename\": \"glassHarmonica.dsp\",	\"version\": \"2.40.12\",	\"compile_options\": \"-lang cpp -es 1 -mcd 16 -uim -single -ftz 0\",	\"include_pathnames\": [\"/usr/local/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/tmp/sessions/384AEEBEC19B512CF868D732298ABE71EE1A670B/unity/windows64/.\"],	\"inputs\": 0,	\"outputs\": 2,	\"meta\": [ 		{ \"author\": \"Romain Michon\" },		{ \"basics_lib_name\": \"Faust Basic Element Library\" },		{ \"basics_lib_version\": \"0.8\" },		{ \"compile_options\": \"-single -scal -I libraries/ -I project/ -lang wasm\" },		{ \"copyright\": \"Romain Michon (rmichon@ccrma.stanford.edu)\" },		{ \"delays_lib_name\": \"Faust Delay Library\" },		{ \"delays_lib_version\": \"0.1\" },		{ \"description\": \"Nonlinear Banded Waveguide Modeled Glass Harmonica\" },		{ \"envelopes_lib_adsr_author\": \"Yann Orlarey and Andrey Bundin\" },		{ \"envelopes_lib_author\": \"GRAME\" },		{ \"envelopes_lib_copyright\": \"GRAME\" },		{ \"envelopes_lib_license\": \"LGPL with exception\" },		{ \"envelopes_lib_name\": \"Faust Envelope Library\" },		{ \"envelopes_lib_version\": \"0.2\" },		{ \"filename\": \"glassHarmonica.dsp\" },		{ \"filters_lib_allpass_comb_author\": \"Julius O. Smith III\" },		{ \"filters_lib_allpass_comb_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_allpass_comb_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_allpassnn_author\": \"Julius O. Smith III\" },		{ \"filters_lib_allpassnn_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_allpassnn_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_lowpass0_highpass1\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_lowpass0_highpass1_author\": \"Julius O. Smith III\" },		{ \"filters_lib_lowpass_author\": \"Julius O. Smith III\" },		{ \"filters_lib_lowpass_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_lowpass_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_name\": \"Faust Filters Library\" },		{ \"filters_lib_tf1_author\": \"Julius O. Smith III\" },		{ \"filters_lib_tf1_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_tf1_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_tf1s_author\": \"Julius O. Smith III\" },		{ \"filters_lib_tf1s_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_tf1s_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_version\": \"0.3\" },		{ \"instruments_lib_author\": \"Romain Michon (rmichon@ccrma.stanford.edu)\" },		{ \"instruments_lib_copyright\": \"Romain Michon\" },		{ \"instruments_lib_licence\": \"STK-4.3\" },		{ \"instruments_lib_name\": \"Faust-STK Tools Library\" },		{ \"instruments_lib_version\": \"1.0\" },		{ \"library_path0\": \"/libraries/instruments.lib\" },		{ \"library_path1\": \"/libraries/envelopes.lib\" },		{ \"library_path10\": \"/libraries/routes.lib\" },		{ \"library_path2\": \"/libraries/maths.lib\" },		{ \"library_path3\": \"/libraries/platform.lib\" },		{ \"library_path4\": \"/libraries/delays.lib\" },		{ \"library_path5\": \"/libraries/filters.lib\" },		{ \"library_path6\": \"/libraries/signals.lib\" },		{ \"library_path7\": \"/libraries/oscillators.lib\" },		{ \"library_path8\": \"/libraries/basics.lib\" },		{ \"library_path9\": \"/libraries/reverbs.lib\" },		{ \"licence\": \"STK-4.3\" },		{ \"maths_lib_author\": \"GRAME\" },		{ \"maths_lib_copyright\": \"GRAME\" },		{ \"maths_lib_license\": \"LGPL with exception\" },		{ \"maths_lib_name\": \"Faust Math Library\" },		{ \"maths_lib_version\": \"2.5\" },		{ \"name\": \"glassHarmonica\" },		{ \"oscillators_lib_name\": \"Faust Oscillator Library\" },		{ \"oscillators_lib_version\": \"0.3\" },		{ \"platform_lib_name\": \"Generic Platform Library\" },		{ \"platform_lib_version\": \"0.2\" },		{ \"reverbs_lib_name\": \"Faust Reverb Library\" },		{ \"reverbs_lib_version\": \"0.2\" },		{ \"routes_lib_hadamard_author\": \"Remy Muller, revised by Romain Michon\" },		{ \"routes_lib_name\": \"Faust Signal Routing Library\" },		{ \"routes_lib_version\": \"0.2\" },		{ \"signals_lib_name\": \"Faust Signal Routing Library\" },		{ \"signals_lib_version\": \"0.3\" },		{ \"version\": \"2.44.5\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"glassHarmonica\",			\"items\": [ 				{					\"type\": \"hgroup\",					\"label\": \"Basic_Parameters\",					\"items\": [ 						{							\"type\": \"nentry\",							\"label\": \"freq\",							\"shortname\": \"freq\",							\"address\": \"/glassHarmonica/Basic_Parameters/freq\",							\"meta\": [								{ \"1\": \"\" },								{ \"tooltip\": \"Tone frequency\" },								{ \"unit\": \"Hz\" }							],							\"init\": 440,							\"min\": 20,							\"max\": 20000,							\"step\": 1						},						{							\"type\": \"nentry\",							\"label\": \"gain\",							\"shortname\": \"gain\",							\"address\": \"/glassHarmonica/Basic_Parameters/gain\",							\"meta\": [								{ \"1\": \"\" },								{ \"tooltip\": \"Gain (value between 0 and 1)\" }							],							\"init\": 0.8,							\"min\": 0,							\"max\": 1,							\"step\": 0.01						},						{							\"type\": \"button\",							\"label\": \"gate\",							\"shortname\": \"gate\",							\"address\": \"/glassHarmonica/Basic_Parameters/gate\",							\"meta\": [								{ \"1\": \"\" },								{ \"tooltip\": \"noteOn = 1, noteOff = 0\" }							]						}					]				},				{					\"type\": \"hgroup\",					\"label\": \"Physical_and_Nonlinearity\",					\"items\": [ 						{							\"type\": \"vgroup\",							\"label\": \"Nonlinear_Filter_Parameters\",							\"items\": [ 								{									\"type\": \"hslider\",									\"label\": \"Modulation_Frequency\",									\"shortname\": \"Modulation_Frequency\",									\"address\": \"/glassHarmonica/Physical_and_Nonlinearity/Nonlinear_Filter_Parameters/Modulation_Frequency\",									\"meta\": [										{ \"3\": \"\" },										{ \"tooltip\": \"Frequency of the sine wave for the modulation of theta (works if Modulation Type=3)\" },										{ \"unit\": \"Hz\" }									],									\"init\": 220,									\"min\": 20,									\"max\": 1000,									\"step\": 0.1								},								{									\"type\": \"nentry\",									\"label\": \"Modulation_Type\",									\"shortname\": \"Modulation_Type\",									\"address\": \"/glassHarmonica/Physical_and_Nonlinearity/Nonlinear_Filter_Parameters/Modulation_Type\",									\"meta\": [										{ \"3\": \"\" },										{ \"tooltip\": \"0=theta is modulated by the incoming signal; 1=theta is modulated by the averaged incoming signal; 2=theta is modulated by the squared incoming signal; 3=theta is modulated by a sine wave of frequency freqMod; 4=theta is modulated by a sine wave of frequency freq;\" }									],									\"init\": 0,									\"min\": 0,									\"max\": 4,									\"step\": 1								},								{									\"type\": \"hslider\",									\"label\": \"Nonlinearity\",									\"shortname\": \"Nonlinearity\",									\"address\": \"/glassHarmonica/Physical_and_Nonlinearity/Nonlinear_Filter_Parameters/Nonlinearity\",									\"meta\": [										{ \"3\": \"\" },										{ \"tooltip\": \"Nonlinearity factor (value between 0 and 1)\" }									],									\"init\": 0,									\"min\": 0,									\"max\": 1,									\"step\": 0.01								}							]						},						{							\"type\": \"vgroup\",							\"label\": \"Physical_Parameters\",							\"items\": [ 								{									\"type\": \"hslider\",									\"label\": \"Base_Gain\",									\"shortname\": \"Base_Gain\",									\"address\": \"/glassHarmonica/Physical_and_Nonlinearity/Physical_Parameters/Base_Gain\",									\"meta\": [										{ \"2\": \"\" },										{ \"tooltip\": \"A value between 0 and 1\" }									],									\"init\": 1,									\"min\": 0,									\"max\": 1,									\"step\": 0.01								},								{									\"type\": \"hslider\",									\"label\": \"Bow_Pressure\",									\"shortname\": \"Bow_Pressure\",									\"address\": \"/glassHarmonica/Physical_and_Nonlinearity/Physical_Parameters/Bow_Pressure\",									\"meta\": [										{ \"2\": \"\" },										{ \"tooltip\": \"Bow pressure on the instrument (Value between 0 and 1)\" }									],									\"init\": 0.2,									\"min\": 0,									\"max\": 1,									\"step\": 0.01								},								{									\"type\": \"nentry\",									\"label\": \"Excitation_Selector\",									\"shortname\": \"Excitation_Selector\",									\"address\": \"/glassHarmonica/Physical_and_Nonlinearity/Physical_Parameters/Excitation_Selector\",									\"meta\": [										{ \"2\": \"\" },										{ \"tooltip\": \"0=Bow; 1=Strike\" }									],									\"init\": 0,									\"min\": 0,									\"max\": 1,									\"step\": 1								},								{									\"type\": \"hslider\",									\"label\": \"Integration_Constant\",									\"shortname\": \"Integration_Constant\",									\"address\": \"/glassHarmonica/Physical_and_Nonlinearity/Physical_Parameters/Integration_Constant\",									\"meta\": [										{ \"2\": \"\" },										{ \"tooltip\": \"A value between 0 and 1\" }									],									\"init\": 0,									\"min\": 0,									\"max\": 1,									\"step\": 0.01								}							]						}					]				},				{					\"type\": \"vgroup\",					\"label\": \"Reverb\",					\"items\": [ 						{							\"type\": \"hslider\",							\"label\": \"reverbGain\",							\"shortname\": \"reverbGain\",							\"address\": \"/glassHarmonica/Reverb/reverbGain\",							\"init\": 0.137,							\"min\": 0,							\"max\": 1,							\"step\": 0.01						},						{							\"type\": \"hslider\",							\"label\": \"roomSize\",							\"shortname\": \"roomSize\",							\"address\": \"/glassHarmonica/Reverb/roomSize\",							\"init\": 0.72,							\"min\": 0.01,							\"max\": 2,							\"step\": 0.01						}					]				},				{					\"type\": \"vgroup\",					\"label\": \"Spat\",					\"items\": [ 						{							\"type\": \"hslider\",							\"label\": \"pan angle\",							\"shortname\": \"pan_angle\",							\"address\": \"/glassHarmonica/Spat/pan_angle\",							\"init\": 0.6,							\"min\": 0,							\"max\": 1,							\"step\": 0.01						},						{							\"type\": \"hslider\",							\"label\": \"spatial width\",							\"shortname\": \"spatial_width\",							\"address\": \"/glassHarmonica/Spat/spatial_width\",							\"init\": 0.5,							\"min\": 0,							\"max\": 1,							\"step\": 0.01						}					]				}			]		}	]}";
			...
			_dsp = (FaustPlugin_glassHarmonica) target;          // Sets which component will be edited in the inspector
		}
	...
	*/
	public class Faust_Context {
		...
		const string _dllName = "libFaustPlugin_glassHarmonica";
		#elif UNITY_IOS
		const string _dllName = "__Internal";
		#elif UNITY_EDITOR || UNITY_ANDROID || UNITY_STANDALONE_LINUX
		const string _dllName = "FaustPlugin_glassHarmonica";
		#else
